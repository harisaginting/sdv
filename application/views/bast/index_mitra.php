                    ...
                    aoColumns: [
                                ...
                                { mData: 'STATUS'},
                                {
                                    'mRender': function(data, type, obj){
                                            ...
                                            var a = "<a style='font-size:10px;'  class=\'btn  btn-xs btn-success circle nav-link-hgn \' href='"+base_url+"bast/view/"+obj.ID_BAST+"'  target='_blank'><i class='glyphicon glyphicon-new-window'></i></a>"
