     ...
     <?php endif; ?>
      ...
      <div class="col-sm-6">
          ...
          <div class="form-group">
            ...
            <input type="text" name="" class="form-control" value="<?= !empty($bast['NAMA_MITRA']) ? $bast['NAMA_MITRA'] : '"'  ?> ">
          </div>
          ...
          <div class="form-group">
            ...
            <input type="text" name="" class="form-control" value="<?= !empty($bast['NO_SPK']) ? $bast['NO_SPK'] : '"'  ?> ">
          </div>
