...
<div class="col-sm-12">
  ...
  <strong>BAST</strong>
  <small>Preview</small>
  <a class="pull-right btn btn-xs btn-info circle2" href="<?= base_url(); ?>/bast/pretemplate/<?= $id_bast; ?>"  id="btn-print" style="margin-left: 10px;"><i class="fa fa-print"></i></a>
  <div class="pull-right btn btn-xs btn-danger  circle2" data-id= "<?= $id_bast; ?>"  id="btn-delete_bast" style="margin-left: 10px;"><i class="fa fa-trash"></i></div>
  </div>
  <div class="card-body">
    <form id="formBast">
      <div class="row">
    ...
    <div class="row">
        ...
        <?php if(!empty($bast['ID_PROJECT'])) : ?>    
            ...
            <div class="col-md-2" style="margin-bottom: 10px;">
              ...
              <a class="btn btn-success form-control" href="<?= base_url().'projects/view/'.$bast['ID_PROJECT'] ?>">
                <i class="fa fa-arrow-alt-circle-right"> View Project</i>
              </a>
            </div>
        <?php endif; ?> 
    </div>
      ...
      <div class="col-sm-6">
          ...
          <div class="form-group" style="min-height: 50px;padding-top: 10px;">
              <div class="row">
                <div class="col-md-3">
                  <input type="checkbox" id="bapp" name="bapp" data-val="bapp" <?= !empty($bast['BAPP']) ? 'checked' : ''; ?> 
                  <?= ($bast['STATUS'] == 'APPROVED') || ($bast['STATUS'] == 'DONE')  || ($bast['STATUS'] == 'TAKE OUT') ? "onclick='return false;'" : ''; ?> >
                  <label for="bapp" class="pull-left">BAPP</label>
                </div>
                <div class="col-md-6">
                  <input type="checkbox" id="p71" name="p71" data-val="P71" onclick='return false;' <?= !empty($bast['P71']) ? 'checked' : '' ?>>
          ...
          <div class="form-group">
            ...
            <input type="text" name="customer" id="customer" class="form-control" value="<?= $bast['NIPNAS'].'||'.$bast['NAMACC']; ?>" required readOnly>
          </div>
          ...
          <div id="progress_periode" class="form-group">
            <label class="control-label">Periode Progress Reccuring</label>
              <div class="input-daterange input-group">
                <input type="text" class="form-control date-picker" name="recc_start_date" placeholder="mm/dd/yyyy" value="<?= !empty($bast['RECC_START_DATE']) ? $bast['RECC_START_DATE2'] : ''; ?>" readOnly>
                  <span class="input-group-addon" style="color:#000;">&nbsp;&nbsp; to &nbsp;&nbsp;</span>
                  <input type="text" class="form-control date-picker" name="recc_end_date" placeholder="mm/dd/yyyy" value="<?= !empty($bast['RECC_END_DATE']) ? $bast['RECC_END_DATE2'] : ''; ?>" readOnly>
                </div>
            </div>
        ...
        <div class="col-sm-12">
          <div class="form-group ">
            ...
            <div class="input-group">
              ...
              <span class="input-group-append">
                <?php if($this->auth->get_access_value('BAST')>2) : ?>
    ...
    var tableInit = function(){ 
      ...
      return {
          init: function() { 
              ...
              $(document).on('click','#btn-delete_bast', function (e) {
                e.stopImmediatePropagation();
                e.preventDefault();
                var id = $(this).data('id');
                console.log(id);
                              ...
                              $.ajax({
                                            ...
                                            $('#pre-load-background').fadeOut();
                                             if(result.data=='success'){
                                              ...
                                              window.location.href = base_url+'bast/view/<?= $id_bast; ?>' ;
                                              });
                                            }else{
