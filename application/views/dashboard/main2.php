...
<div class="container-fluid container-content-no-bread" style="padding-top: 5px !important;;">
  <div class="animated fadeIn"></div>
    ...
    <div class="row" style="margin-top: -100px !important;" id="con_projectTypeData">
        <div class="col-md-2">               
              <div class="card" style="">
                  <?php $c=0; foreach ($total_project_c as $key => $value) : ?>
                      <?php //if(!empty($value)) : ?>
                      <div class="card" style="height: 40px;margin-bottom: 2px;border:2px solid #0b8fc1;">
                        <div class="card-body p-0 d-flex align-items-center" style="<?= !empty($value) ? "background: #dfdfdf;" : ""; ?>height: 36px;">
                        <span class="bg-info p-4 font-2xl mr-3" style="height: 36px; padding-top: 3px !important;padding-bottom: 7px !important; min-width: 70px;font-family: monospace;font-weight: 900;background: <?= $colorTProj[$c]; ?> !important"><?= substr($key, 0,3) ?></span>
                          <div style=""  >
