...
.bg-purple{
    background: url(https://www.telkomsolution.id/themes/v2/img-en/maritime/background-02.png);
        ...
        <div class="stars">
            <div class="custom-navbar">
                <div class="brand-logo">
                    <img src="https://www.telkomsolution.id/themes/v2/img-en/logo.png" width="80px">
                </div>
            </div>
