            ...
            <form action="" method="POST">
                <div class="form-group">
                    <label for="inputNik">NIK - NAME AM</label>
                      <select name="am_cc_nik" id="am_cc_nik" class="form-control" required="required" style="width:100%;">
                        <option value=""></option>
                ...
                <div class="form-group">
                    ...
                    <select name="am_cc_nipnas" id="am_cc_nipnas" class="form-control" required="required" style="width:100%;">
                        <option value=""></option>
