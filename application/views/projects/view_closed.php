...
<div class="container-content">
		...
		<div class="col-md-12"> 
			<div class="card">
				...
				<div class="card-body collapse show" id="collapseExample">
					<div class="row">	
						<div class="col-md-6">
							<table class="table table-striped" style="border:2px #b9b9b9 solid;">
									<tr>
										<td style="width: 20% !important;">Project Name</td>
										<td>: <?=$listDetail['NAME']?></td>
									</tr>
									<tr>
										<td>Value</td>
										<td>: Rp. <?=number_format($listDetail['VALUE'])?></td>
									</tr>
									<tr>
										<td>Customer</td>
									...
									<?php }else{ ?>
										<tr>
											<td>Partners</td>
											<td id="partners_field">: <?=$partners[0]['PARTNERS']?></td>
										</tr>
									<?php } ?>
									...
									<?php if(!empty($listDetail['REGIONAL'])) : ?>
									<tr>
										<td>Regional</td>
						...
						<div class="col-md-6">
							<table class="table table-striped" style="border:2px #b9b9b9 solid;">
									...
									<tr>
										<td>Closed Date</td>
										<td>: <?=date('d/m/Y',strtotime($listDetail['CLOSED_DATE'])).' by ['.$listDetail['CLOSED_BY_ID'].'] - '.$listDetail['CLOSED_BY_NAME']; ?></td>
									</tr>
									<tr>
									...
									<?php if(!empty($listDetail['NO_QUOTE'])) : ?>
									<tr>
										<td>NO QUOTE NCX OR TCARES </td>
										<td>: <?= $listDetail['NO_QUOTE']; ?> <span class="<?= $listDetail['NO_QUOTE_VALID'] == '1'? 'text-success' :'text-danger' ?>"><?= $listDetail['NO_QUOTE_VALID'] == '1'? 'VALIDATED' :'NOT VALIDATED' ?></span></td>
									</tr>
									<?php endif; ?>
							...
							<div class="row">
					            ...
					            <?php endif;?>
					              ...
					              <?php if(!empty($listDetail['DOC_KL'])) : ?>
					          		...
					          		<?php if(!empty($listDetail['CLOSED_EVIDENCE'])) : ?>
					              <div class="col-md-3">
					                <div class="form-group">
					                  <label class=" control-label">Closed Evidence</label>
					                    <input id="doc_closed" name="doc_closed" type="file" accept="pdf" class="form-control file" >
					                </div>
					              </div>
					              	<?php endif;?>
					        </div>
	...
	<div class="row">
		...
		<ul class="nav nav-tabs" role="tablist">
			<li class="nav-item">
			<a class="nav-link" data-toggle="tab" href="#deliverable" role="tab" aria-controls="deliverable">Deliverable <span class="badge badge-pill	 badge-info" style="font-size: 10px;visibility: hidden;" id="#badge_deliverable">0</span></a>
			</li>
			<li class="nav-item">
			...
			<li class="nav-item">
			<a class="nav-link active" data-toggle="tab" href="#bast" role="tab" aria-controls="history">BAST <span class="badge badge-pill	 badge-info" style="font-size: 10px;"><?= count($bast); ?> </span></a>
			</li>
		</ul>
			...
			<div class="tab-pane active" id="bast" role="tabpanel">
	...
	var Page = function () {
		...
		<?php if(!empty($listDetail['DOC_RFP'])) : ?>
              ...
              $("#doc_kb").fileinput({
                  ...
                  initialPreviewAsData: true,
                  initialPreviewConfig: [
                      {type: "pdf", url: "https://prime.telkom.co.id/_files/<?= $listDetail['DOC_KB'] ?>", downloadUrl: "https://prime.telkom.co.id/_files/<?= $listDetail['DOC_KB'] ?>"}, 
                  ],
                  purifyHtml: true, 
                  autoReplace: true,
                  maxFileCount: 1,
              ...
              <?php if(!empty($listDetail['CLOSED_EVIDENCE'])) : ?>
              $("#doc_closed").fileinput({
                  overwriteInitial: false,
                  initialPreview: [
                      "https://prime.telkom.co.id/_files/<?= $listDetail['CLOSED_EVIDENCE'] ?>",
                  ],
                  initialPreviewAsData: true,
                  initialPreviewConfig: [
                      {type: "pdf", url: "https://prime.telkom.co.id/_files/<?= $listDetail['CLOSED_EVIDENCE'] ?>", downloadUrl: "ttps://prime.telkom.co.id/_files/<?= $listDetail['CLOSED_EVIDENCE'] ?>"}, 
                  ],
                  purifyHtml: true, 
                  autoReplace: true,
                  maxFileCount: 1,
              ...
              $("#doc_kl").fileinput({
                  ...
                  initialPreviewAsData: true,
                  initialPreviewConfig: [
                      {type: "pdf", url: "https://prime.telkom.co.id/_files/<?= $listDetail['DOC_KL'] ?>", downloadUrl: "https://prime.telkom.co.id/_files/<?= $listDetail['DOC_KL'] ?>", 
                  ],
                  purifyHtml: true, 
                  autoReplace: true,
                  maxFileCount: 1,
