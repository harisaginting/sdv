...
<div class="container-content">
					...
					<div class="row">	
						<div class="col-sm-12 col-md-12">
							<table class="table table-striped">
									...
									<tr>
										<td>Lesson Learn</td>
										<td>: <?=$listDetail['LESSON_LEARNED']?></td>
									</tr>
							</table>
						</div>
						<div class="col-sm-12 col-md-12">
	...
	<div class="row">
		...
		<ul class="nav nav-tabs" role="tablist">
			<li class="nav-item">
			<a class="nav-link active" data-toggle="tab" href="#deliverable" role="tab" aria-controls="deliverable">Deliverable</a>
			</li>
			<li class="nav-item">
			<a class="nav-link" data-toggle="tab" href="#issue" role="tab" aria-controls="issue">Issue</a>
			</li>
			<li class="nav-item">
			<a class="nav-link" data-toggle="tab" href="#action" role="tab" aria-controls="action">Action Plan</a>
			</li>
			<li class="nav-item">
			<a class="nav-link" data-toggle="tab" href="#history" role="tab" aria-controls="history">Action History</a>
			</li>
			<li class="nav-item">
			<a class="nav-link" data-toggle="tab" href="#bast" role="tab" aria-controls="history">BAST</a>
			</li>
		</ul>
						...
						<div class="col-sm-2">
	          			...
	          			<div class="col-sm-6 offset-md-4">   
	          				<div class="row">   		
		          				<div class="col-sm-6">
									...
									<div>Sum Of Realization 
										<strong class="badge badge-pill badge-primary "><span class="h4"><?=number_format($sum_weight_rea['TOTAL_WEIGHT'])?> %</span></strong>
									</div>
									<div class="progress progress-xs my-3">
									<div class="progress-bar bg-primary" role="progressbar" style="width: <?=number_format($sum_weight_rea['TOTAL_WEIGHT'])?>%" aria-valuenow="<?=number_format($sum_weight_rea['TOTAL_WEIGHT'])?> %" aria-valuemin="0" aria-valuemax="100"></div>
									</div>
									</div>
									</div>
								</div>
								<div class="col-sm-6">
									...
									<div class="card-body">
									<div>Sum Of Realization 
										<strong class="badge badge-pill badge-success "><span class="h4"><?=number_format($sum_weight_rea['REAL'])?> %</span></strong>
									</div>
									<div class="progress progress-xs my-3">
									<div class="progress-bar bg-success" role="progressbar" style="width: <?=number_format($sum_weight_rea['REAL'])?>%" aria-valuenow="<?=number_format($sum_weight_rea['REAL'])?>" aria-valuemin="0" aria-valuemax="100"></div>
									</div>
									</div>
									</div>
								</div>
		              		 ...
		              		 <div class="table-responsive w-xm wrapper">
							       	<table id="dataDeliverable" class="table table-striped b-t" style="width:100% !important;">
				            ...
				            <div class="col-sm-2" style="margin-bottom: 10px;">
								<button type="button" id="saveDetailDeliverable" class="hidden btn btn-success btn-addon"><i class="fa fa-floppy-o"></i>Save
								</button>
		          			</div>
                    ...
                    <form method="POST" enctype="multipart/form-data" id="frmIssue">
                        ...
                        <div class="form-group row editInput">
                            ...
                            <div class="col-md-9">
                                ...
                                <select name="status" class="form-control statusSelect" onchange="showClosedDate(this.value,'issue');checkClosedAction()" id="issueStatus">
                        ...
                        <div class="form-group row closedIssue" style="display:none;">
                            ...
                            <div class="col-md-9">
                               <input type="text" name="closed_date" placeholder="mm/dd/yyyy" class="form-control datepicker closed_date_issue" readOnly>
                            </div>
                        </div>
                ...
                <div class="modal-body">
                    <form method="POST" enctype="multipart/form-data" id="frmAction">
                        ...
                        <div class="form-group row editInput">
                            ...
                            <div class="col-md-9">
                                <select name="status_action" class="form-control statusSelect" onchange="showClosedDate(this.value,'action')">
                                	<option value="" disabled selected>Select Status</option>
                                	<option value="OPEN">OPEN</option>
                                	<option value="CLOSED">CLOSED</option>
                                </select>
                         ...
                         <div class="form-group row closedeAction" style="display:none;">
                            <div class="col-md-3">
                                <label class="form-control-label cd">Closed Date</label>
                            </div>
     
                            <div class="col-md-9">
                               <input type="text" name="action_closed_date" placeholder="mm/dd/yyyy" class="form-control datepicker" id="action_close_date">
                            </div>
                        </div>
                        <div class="modal-footer">
                         ...
                         <div class="row">
                         	<div class="col-sm-12">
						                  	...
						                  	<?php foreach($document as $key=>$value) :?>
						                          <tr>
						                              ...
						                              <td>
						                              	...
						                              	href="https://prime.telkom.co.id/sdv/../_files/<?= $document[$key]['ATTACHMENT']; ?>" download target="_blank">
                         		...
                         		<div class="offset-md-4 col-md-4">
                         			<div class="form-group">
			                                <input type="file" class="form-control" name="documentProject[]" id="documentProject" accept="pdf">
			                        </div>
                         		</div>	
                         	</div>
                         </div>
...
var total_weight 	= '<?=$sum_weight_rea['TOTAL_WEIGHT']?>'; 
var start_week_1	= '<?=$listDetail['START_WEEK_1']?>';
	...
	var Page = function () {
		...
		$('#attachment_deliverable').fileinput({
						  uploadUrl : 'projects/upload_file_deliverable/'+id_project,
						  autoReplace: true,
				          maxFileCount: 1,                   
				          dropZoneEnabled: false,
			              mainClass: "input-group",
		...
		$('#attachment_issue').fileinput({
						  uploadUrl : 'projects/upload_file_issue/'+id_project,
						  autoReplace: true,
				          maxFileCount: 1,                   
				          dropZoneEnabled: false,
			              mainClass: "input-group",
		...
		$('#attachment_action').fileinput({
						  uploadUrl : 'projects/upload_file_action/'+id_project,
						  autoReplace: true,
				          maxFileCount: 1,                   
				          dropZoneEnabled: false,
			              mainClass: "input-group",
      	...
      	var tableDeliverable  	= function(){
            ...
            aoColumns: [
                ...
                },
                {
                    'mRender': function(data, type, obj){
                           ...
                           return   "<span style='width:45%;color:#000 !important;' class=\'btn  btn-xs btn-success BtnUpdateDeliverable  circle \' data-id='"+obj.ID_DELIVERABLE+"' ><i class='fa fa-cloud-upload-alt'></i></span>";
                    }
   		...
   		var tableIssue 			= function(){
            ...
            aoColumns: [
                ...
                { 
                    'mRender': function(data, type, obj){   
                            if(obj.MITIGATION_PLAN != null){
                                return obj.MITIGATION_PLAN;
                            }else{
                                return "-";
                            }   
                    }            
      ...
      return {	
          init: function() { 
		    ...
		    Awesomplete.$('#issue_picname1').addEventListener("awesomplete-selectcomplete", function(e) {
		        ...
		        $.ajax({
		            type:"GET",
		            url: "json/get_json_pic_email?q="+q,
		            success : function(data){
			...
			$(document).on('fileuploaded','#attachment_deliverable', function(event, data, previewId, index) {
			     var file_path = data.response.full_path;
			...
			$(document).on('click','.btnAddDeliverable', function () {
	         ...
	         $("#ui-view").on('click','.BtnUpdateDeliverable', function (e) {
	                ...
	                $.ajax({
	                        type:"POST",
	                        url:base_url+"index.php/projects/get_detail_deliverable",
	                           	...
	                           	if(attachment_deliverable != null){
		                            ...
		                            $("#attachment_deliverable").fileinput({
						                  ...
						                  initialPreviewConfig: [
						                      {type: "pdf", url:attachment_deliverable, downloadUrl: false}, 
						                  ],
						                  purifyHtml: true, 
						                  autoReplace: true,
						                  maxFileCount: 1,
	                    ...
	                    $.ajax({
	                        ...
	                        success: function(datajson) {
	                            ...
	                            if(data['STATUS_ISSUE']=="CLOSED"){
	                                $(".closed_date_issue").val(moment(new Date (data['ISSUE_CLOSED_DATE'])).format('mm/dd/yyyy'))
	                                $(".closedIssue").show();
	                            }
	                            $(".editInput").show();
	                            ...
	                            $("#attachment_issue").fileinput({
					                  ...
					                  initialPreviewAsData: true,
					                  initialPreviewConfig: [
					                      {type: "pdf", url: attachment_issue, downloadUrl: false}, 
					                  ],
					                  purifyHtml: true, 
					                  autoReplace: true,
					                  maxFileCount: 1,
	            ...
	            var id_ap = $(this).data('id');
	                ...
	                complete: function() {
	                    ...
	                    $("#attachment_action").fileinput({
					                  ...
					                  initialPreviewAsData: true,
					                  initialPreviewConfig: [
					                      {type: "pdf", url: attachment_action, downloadUrl: false}, 
					                  ],
					                  purifyHtml: true, 
					                  autoReplace: true,
					                  maxFileCount: 1,
		    ...
		    image.src = 'data:image/svg+xml;base64,' + window.btoa(svg);   
              ...
              $("#doc_rfp").fileinput({
                  ...
                  initialPreviewAsData: true,
                  initialPreviewConfig: [
                      {type: "pdf", url: "https://prime.telkom.co.id/_files/<?= $listDetail['DOC_RFP'] ?>", downloadUrl: false}, 
                  ],
                  purifyHtml: true, 
                  autoReplace: true,
                  maxFileCount: 1,
              ...
              $("#doc_proposal").fileinput({
                  ...
                  initialPreviewAsData: true,
                  initialPreviewConfig: [
                      {type: "pdf", url: "https://prime.telkom.co.id/_files/<?= $listDetail['DOC_PROPOSAL'] ?>", downloadUrl: false}, 
                  ],
                  purifyHtml: true, 
                  autoReplace: true,
                  maxFileCount: 1,
              ...
              $("#doc_aanwizing").fileinput({
                  ...
                  initialPreviewAsData: true,
                  initialPreviewConfig: [
                      {type: "pdf", url: "https://prime.telkom.co.id/_files/<?= $listDetail['DOC_AANWIZING'] ?>", downloadUrl: false}, 
                  ],
                  purifyHtml: true, 
                  autoReplace: true,
                  maxFileCount: 1,
              ...
              $("#doc_spk").fileinput({
                  ...
                  initialPreviewAsData: true,
                  initialPreviewConfig: [
                      {type: "pdf", url: "https://prime.telkom.co.id/_files/<?= $listDetail['DOC_SPK'] ?>", downloadUrl: false}, 
                  ],
                  purifyHtml: true, 
                  autoReplace: true,
                  maxFileCount: 1,
              ...
              $("#doc_bakn").fileinput({
                  ...
                  initialPreviewAsData: true,
                  initialPreviewConfig: [
                      {type: "pdf", url: "https://prime.telkom.co.id/_files/<?= $listDetail['DOC_BAKN_PB'] ?>", downloadUrl: false}, 
                  ],
                  purifyHtml: true, 
                  autoReplace: true,
                  maxFileCount: 1,
