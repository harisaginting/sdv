...
<div class="col-md-10">  
  <div class="pull-right">
      <a href="<?= base_url(); ?>monitoring/download_pm_activity" class="btn btn-primary btn-addon text-white"><i class="fa fa-download"></i>
        <span style="padding-right: 0px;" class="float-left"> &nbsp; Download Summary Activity&nbsp;&nbsp;&nbsp;&nbsp;</span>
      </a>
  </div> 
  <div  class="pull-right" style="margin-right: 10px;">
      <a href="<?= base_url(); ?>monitoring/download_monitoring_project_manager" class="btn btn-primary btn-addon"  ><i class="fa fa-download"></i>
        <span class="float-left"> &nbsp; Download Load PM &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
      </a>
  </div>
</div>
</ol>
